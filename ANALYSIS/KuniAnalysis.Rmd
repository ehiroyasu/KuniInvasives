...
altruism<-calc_values(kuni_df, v1="male_altruism1", v2="male_altruism2", v3="male_altruism3")
egoism<-calc_values(kuni_df, v1="male_ego1", v2="male_ego2", v3="male_ego3")
biospherism<-calc_values(kuni_df, v1="male_bio1", v2="male_bio2", v3="male_bio3")
male_values<-data.frame(altruism, egoism, biospherism)

altruism<-calc_values(kuni_df, v1="female_altruism1", v2="female_altruism2", v3="female_altruism3")
egoism<-calc_values(kuni_df, v1="female_ego1", v2="female_ego2", v3="female_ego3")
biospherism<-calc_values(kuni_df, v1="female_bio1", v2="female_bio2", v3="female_bio3")
female_values<-data.frame(altruism, egoism, biospherism)

values_tot<-female_values+male_values
values_adj<-values_tot/3

kuni_df<-cbind(kuni_df, values_adj)
write.csv(kuni_df, "Kuni_Data_11_14_IncValues.csv")
```
